...
var weapon_icons = {
    weapon_c75za: "http://vignette3.wikia.nocookie.net/cswikia/images/c/cf/C75a_hud_csgo.png/revision/latest/scale-to-width-down/400",
    ...
    weapon_g3sg1: "http://vignette4.wikia.nocookie.net/cswikia/images/4/4a/G3sg1_hud_csgo.png/revision/latest/scale-to-width-down/400",
    ...
    weapon_c4: "http://vignette1.wikia.nocookie.net/cswikia/images/f/fc/C4_ticking_source.png/revision/latest/scale-to-width-down/400",
    weapon_hegrenade: "http://vignette1.wikia.nocookie.net/cswikia/images/6/60/Ammo_hegrenade_css.png/revision/latest/scale-to-width-down/400",
    weapon_molotov: "http://vignette3.wikia.nocookie.net/cswikia/images/f/fc/Molotov_hud_csgo.png/revision/latest/scale-to-width-down/400",
    weapon_flashbang: "http://vignette2.wikia.nocookie.net/cswikia/images/a/af/Flashbang_hud_csgo.png/revision/latest/scale-to-width-down/400",
    weapon_decoy: "http://vignette1.wikia.nocookie.net/cswikia/images/7/78/Decoy_hud.png/revision/latest/scale-to-width-down/400",
    weapon_smokegrenade: "http://vignette3.wikia.nocookie.net/cswikia/images/4/48/Smokegrenade_hud_csgo.png/revision/latest/scale-to-width-down/400",
    weapon_incgrenade: "http://vignette2.wikia.nocookie.net/cswikia/images/4/45/Incgrenade_hud_csgo.png/revision/latest/scale-to-width-down/400",

    weapon_knife: "http://vignette2.wikia.nocookie.net/cswikia/images/4/4b/Knife_ct_hud_outline_csgo.png/revision/latest/scale-to-width-down/400",
    ...
    weapon_knife_bayonet: "http://vignette2.wikia.nocookie.net/cswikia/images/2/28/Csgo_knife_Bayonet.png/revision/latest/scale-to-width-down/400",
    ...
    weapon_knife_shadow_dagger: "http://vignette4.wikia.nocookie.net/cswikia/images/f/f1/Knife_push_hud_outline_csgo.png/revision/latest/scale-to-width-down/400"

}

document.getElementById("standings").style.display = "none"; // Vanish element to prevent old values from staying there
...
function clear_imgs(ids) {
    for (var i = 0; i < ids.length; i++) {
        document.getElementById(ids[i]).setAttribute("src", "");
    }
}
...
socket.on('update', (json) => {
    ...
    document.getElementById("standings").style.display = "none"; // Vanish element to prevent old values from staying there
    clear(["activity", "team", "health", "armor", "money", "map_txt"]); // Clears everything to prevent old values from staying there.
    clear_imgs(["map_img", "weapon_0", "weapon_1", "weapon_2", "weapon_3", "weapon_4", "weapon_5", "weapon_6", "weapon_7", "weapon_8"]); // Same with imgs
    //

    if (json.hasOwnProperty("map")) {
        // Map img + name
        map_name = json.map.name;
        set_src("/assets/img/" + map_name + ".png", "map_img");
        set_innerhtml(map_name, "map_txt");

        // Standings
        document.getElementById("standings").style.display = null; // Remove "display: none;" to unvanish element
    ...
    if (json.hasOwnProperty("player")) {
        ...
        set_innerhtml("<b>Activity:</b> " + json.player.activity, "activity")
        set_innerhtml("<b>Team:</b> " + json.player.team, "team");

        if (json.player.hasOwnProperty("state")) {
            set_innerhtml("<b>Health:</b> " + json.player.state.health, "health");
            set_innerhtml("<b>Armor:</b> " + json.player.state.armor, "armor");
        ...
        if (json.player.hasOwnProperty("weapons")) {
            ...
            for (var weapon_slot in weapons) {
                ...
                set_src(weapon_icons[json_weapon.name], weapon_slot);

                if (json_weapon.state == "active") {
                    document.getElementById(weapon_slot).style.backgroundColor = "green";
                } else if (json_weapon.state == "reloading") {
                    document.getElementById(weapon_slot).style.backgroundColor = "orange";
                } else {
