...
2
    if (document.getElementById("waiting-container")) document.getElementById("waiting-container").remove();
    ...
    clear_imgs(["weapon_0", "weapon_1", "weapon_2", "weapon_3", "weapon_4", "weapon_5", "weapon_6", "weapon_7", "weapon_8"]); // Same with imgs
    //
    ...
    if (json.hasOwnProperty("player")) {
        ...
        if (json.player.hasOwnProperty("state")) {
            ...
            if (flash_value > 0) {
                effect_container.style.backgroundColor = "rgba(255, 255, 255, " + String(flash_value/255) + ")";
            } else if (smoke_value > 0) {
                effect_container.style.backgroundColor = "rgba(79, 79, 79, " + String(smoke_value/255) + ")";
            } else {
        ...
        if (json.player.hasOwnProperty("weapons")) {
            ...
            for (var weapon_slot in weapons) {
                ...
                if (json_weapon.state == "active") {
                    document.getElementById(weapon_slot).style.backgroundColor = "rgba(0, 255, 0, 0.25)";
                } else if (json_weapon.state == "reloading") {
                    document.getElementById(weapon_slot).style.backgroundColor = "rgba(255, 135, 0, 0.25)";
                } else {
